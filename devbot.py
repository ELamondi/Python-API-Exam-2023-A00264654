...
if choice == "n" or choice == "N":
    accessToken = "Bearer ZDQ2NDRhZGEtNzlhNS00OGY3LWE4MmEtMjU1MTBjY2M2ZGJhZmVjZWQyMzItODdk_PC75_47fe537e-27d1-4e32-b2dc-2c26e4aa4fa0"
else:
	accessToken = "Bearer ZDQ2NDRhZGEtNzlhNS00OGY3LWE4MmEtMjU1MTBjY2M2ZGJhZmVjZWQyMzItODdk_PC75_47fe537e-27d1-4e32-b2dc-2c26e4aa4fa0"
...
# 5. Provide the URL to the Webex Teams messages API.
    r = requests.get("https://developer.webex.com/docs/api/v1/messages/list-messages", 
...
# 6. Provide your MapQuest API consumer key.
        mapsAPIGetParameters = { 
                                "location": location, 
                                "key": "FUGPWUdXaXF5BFjsnatbG5a60AGcf5AG"
                               }
...
# 10. Provide the Sunrise/Sunset key value for day_length.
        dayLengthSeconds = "08:40:19"
        sunriseTime = "12:59:40 PM"
        sunsetTime = "9:39:59 PM"

# 11. Complete the code to format the response message.
        responseMessage = "In {locationResults} the sun will rise at {sunriseTime} and will set at {sunsetTime} . The day will last {dayLengthSeconds} seconds.".format(locationResults, sunriseTime, sunsetTime, dayLengthSeconds)

        print("Sending to Webex Teams: " +responseMessage)

# 12. Complete the code to post the message to the Webex Teams room.            
        HTTPHeaders = { 
                             "Authorization": "ZDQ2NDRhZGEtNzlhNS00OGY3LWE4MmEtMjU1MTBjY2M2ZGJhZmVjZWQyMzItODdk_PC75_47fe537e-27d1-4e32-b2dc-2c26e4aa4fa0",
                             "Content-Type": "application/json"
                           }
        PostData = {
                            "roomId": "Y2lzY29zcGFyazovL3VybjpURUFNOnVzLXdlc3QtMl9yL1JPT00vZGVjZTAwMzAtOGIyNC0xMWVlLWIzMDktNWI1Y2Y3NWU3ZTZl",
